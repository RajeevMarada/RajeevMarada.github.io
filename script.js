/* FINAL PERFORMANCE OPTIMIZED & POLISHED SCRIPT
   ==================================================================================
   V10.0 ("2.0") - ANIMATION REFINEMENT
   - EducationCard: Sped up animation duration from 0.4s to 0.3s and
     changed ease to 'power2.out' for a smoother, faster feel.
     Verified that independent tab logic is correct.
   - ExperienceMasterDetail: Sped up animations for opening (0.5s to 0.35s)
     and closing (0.3s) and changed ease to 'power2.out' for consistency.
   ================================================================================== */
...
// ============================================================================
// *** 2.0 UPDATE: FASTER/SMOOTHER EDUCATION CARD TOGGLE ***
// ============================================================================
class EducationCard {
  constructor() {
      ...
      card.addEventListener('click', () => {
        ...
        if (isActive) {
          ...
          card.animation.to(content, {
            ...
            marginTop: 30,
            duration: 0.3, // *** 2.0: FASTER ***
            ease: 'power2.out', // *** 2.0: SMOOTHER ***
          })
          .fromTo(listItems, 
            { opacity: 0, y: 10 },
            { opacity: 1, y: 0, duration: 0.3, stagger: 0.05, ease: 'power2.out' }, // *** 2.0: FASTER STAGGER ***
...
// ============================================================================
// *** PERFORMANCE: PROJECT ACCORDION (FASTER GSAP) ***
// ============================================================================
    ...
    this.buttons.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        gsap.to(content, {
            ...
            duration: 0.4, // *** PERFORMANCE: Faster (was 0.6) ***
...
// ============================================================================
// *** 2.0 UPDATE: FASTER/SMOOTHER EXPERIENCE MASTER-DETAIL ***
// ============================================================================
class ExperienceMasterDetail {
    ...
    // *** 2.0 UPDATE: Reusable close function ***
    closeDetailPanel() {
...
new EducationCard(); // This now contains the 2.0 fixes
new ProjectAccordion(); // This now contains the fixes
